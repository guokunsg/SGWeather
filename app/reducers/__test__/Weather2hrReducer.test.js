...
const actionLoading = { type: W2HrActionTypes.Start, data: null, error: null }
const actionData = { type: W2HrActionTypes.DataReady, data: JSON.parse(SAMPLE_DATA), error: null }
const actionError = { type: W2HrActionTypes.Error, data: null, error: new Error('Network error') }
